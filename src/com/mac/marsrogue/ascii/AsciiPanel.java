 ...
 */
public class AsciiPanel extends JPanel implements KeyListener{
    ...
    private String terminalFontFile = "assets/fonts/cp437_8x8.png";
    ...
    public void paint(Graphics g) {
        ...
        for(Component component : getComponents()) component.paint(g);
    ...
    private void loadGlyphs() {
        try {
            InputStream in = AsciiPanel.class.getClassLoader().getResourceAsStream(terminalFontFile);
            glyphSprite = ImageIO.read(in);
            //            glyphSprite = ImageIO.read(new FileInputStream(terminalFontFile));
        } catch (IOException e) {
